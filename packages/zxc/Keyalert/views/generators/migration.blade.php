...
class KeyAlertSetupTables extends Migration
{
    ...
    public function up()
    {
        Schema::create('{{$keyalert_scripts_table}}', function(Blueprint $table)
        {
            $table->increments('id');
        ...
        Schema::create('{{$keyalert_table}}', function(Blueprint $table)
        {
    ...
    {
        Schema::drop('{{ $keyalert_table }}');
        Schema::drop('{{ $keyalert_scripts_table }}');
    }
}
