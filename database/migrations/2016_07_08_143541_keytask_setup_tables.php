...
class KeyTaskSetupTables extends Migration
{
    ...
    public function up()
    {
        Schema::create('zxc__key_task', function(Blueprint $table)
        {
            $table->increments('id');
        ...
        Schema::create('zxc__key_task_hour', function(Blueprint $table)
        {
            $table->increments('id');
            ...
            $table->timestamps();
            $table->foreign('task_id')->references('id')->on('zxc__key_task')
    ...
    {
        Schema::drop('zxc__key_task_hour');
        Schema::drop('zxc__key_task');
    }
}
